...
def find_clstr ():
    ...
    inv_data = "C:\\Users\\Administrator.DEMO\\Desktop\\clstrsvm.xlsx"
    ...
    cons_df.to_excel("C:\\Users\\Administrator.DEMO\\Desktop\\clstrvol.xlsx", sheet_name='clstrvol', index=False, header=False)
